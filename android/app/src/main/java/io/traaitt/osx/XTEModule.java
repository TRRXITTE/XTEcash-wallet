...
public class XTEModule extends ReactContextBaseJavaModule {
    static {
        System.loadLibrary("xte_jni");
    }

    public XTEModule(ReactApplicationContext reactContext) {
        super(reactContext); //required by React Native
    }

    /* Access this by doing NativeModules.XTE in react */
    @Override
    ...
    private void getWalletSyncDataImpl(
        ...
        try
        {
            ...
            /* XTE-v1.0.1 */
            connection.setRequestProperty("User-Agent", "XTE-v1.0.1");
